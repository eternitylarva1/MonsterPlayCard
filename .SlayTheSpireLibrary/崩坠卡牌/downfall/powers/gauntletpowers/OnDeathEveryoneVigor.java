...
/*    */ 
/*    */ public class OnDeathEveryoneVigor
/*    */   extends AbstractPower {
/* 17 */   public static final String POWER_ID = downfallMod.makeID("OnDeathEveryoneVigor");
...
/*    */ 
/*    */   
/*    */   public OnDeathEveryoneVigor(AbstractCreature owner, int amount) {
/* 26 */     this.ID = POWER_ID;
/* 27 */     this.owner = owner;
...
/*    */   public void onDeath() {
/* 42 */     flash();
/* 43 */     addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)AbstractDungeon.player, this.owner, (AbstractPower)new VigorPower((AbstractCreature)AbstractDungeon.player, this.amount), this.amount));
/* 44 */     for (AbstractMonster m : (AbstractDungeon.getCurrRoom()).monsters.monsters) {
/* 45 */       if (!m.isDying && !m.isDead) {
/* 46 */         addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)m, this.owner, new MonsterVigor((AbstractCreature)m, this.amount), this.amount));
/*    */       }
/*    */     } 
/*    */   }
/*    */ 
...
/* Location:              C:\Users\gaoming\Desktop\杀戮尖塔 mod\Downfall.jar!\downfall\powers\gauntletpowers\OnDeathEveryoneVigor.class
