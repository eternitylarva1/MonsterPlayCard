...
/* 23 */     this.color = new Color(0.0F, 0.0F, 0.0F, 1.0F);
/* 24 */     this.color.r = MathUtils.random(0.5F, 0.6F);
/* 25 */     this.color.g = this.color.r + MathUtils.random(0.0F, 0.2F);
/* 26 */     this.color.b = 0.2F;
/* 27 */     if (MathUtils.randomBoolean()) {
/* 28 */       this.img = ImageMaster.EXHAUST_L;
/*    */     } else {
/* 30 */       this.img = ImageMaster.EXHAUST_S;
/*    */     } 
/* 32 */     this.duration = MathUtils.random(1.25F, 1.5F);
/* 33 */     this.targetScale = MathUtils.random(0.5F, 1.0F);
/*    */     
...
/* 51 */     this.x += this.vY;
/* 52 */     this.y += MathUtils.random(-2.0F * Settings.scale, 2.0F * Settings.scale);
/* 53 */     this.y += this.vY;
/* 54 */     this.rotation += this.aV * Gdx.graphics.getDeltaTime();
/* 55 */     this.scale = Interpolation.exp10Out.apply(0.01F, this.targetScale, 1.0F - this.duration / this.startDur);
...
/* Location:              C:\Users\gaoming\Desktop\杀戮尖塔 mod\Downfall.jar!\charbosses\vfx\ReasonableAmountOfSmoke.class
