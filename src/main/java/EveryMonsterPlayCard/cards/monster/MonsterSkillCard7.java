...
public class MonsterSkillCard7 extends AbstractMonsterCard {
    public static final String ID = "EveryMonsterPlayCard:MonsterSkillCard7";
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Disarm");

    public MonsterSkillCard7() {
        super("EveryMonsterPlayCard:MonsterSkillCard7", cardStrings.NAME, "red/skill/disarm", 1, cardStrings.DESCRIPTION,
