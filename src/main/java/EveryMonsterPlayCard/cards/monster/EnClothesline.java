...
public class EnClothesline extends AbstractMonsterCard {
    ...
    public EnClothesline() {
        super("downfall_Charboss:Clothesline", cardStrings.NAME, "red/attack/clothesline", 2, cardStrings.DESCRIPTION,
