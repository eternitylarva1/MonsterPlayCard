 ...
 *  com.megacrit.cardcrawl.monsters.MonsterQueueItem
...
public class MonsterGroup {
    private static final Logger logger = LogManager.getLogger((String)MonsterGroup.class.getName());
    ...
    public AbstractMonster getRandomMonster(AbstractMonster exception, boolean aliveOnly) {
        ...
        if (exception == null) {
            if (aliveOnly) {
                ...
                return (AbstractMonster)tmp.get(MathUtils.random((int)0, (int)(tmp.size() - 1)));
            }
            return this.monsters.get(MathUtils.random((int)0, (int)(this.monsters.size() - 1)));
        }
        if (this.monsters.size() == 1) {
            return this.monsters.get(0);
        }
